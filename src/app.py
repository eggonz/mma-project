...
def create_umap(data):
    fig = px.scatter(data, x="energy_label", y="nr_bedrooms", custom_data=['funda'], height= 300)
    fig.update_layout(
...
app = Dash(__name__, assets_folder=ASSETS_PATH, external_stylesheets=[dbc.themes.LITERA])
